...
export class Router {
  ...
  /** Public accessors so IRouter consumers (ConnEnd, ShapeConnectionPin) can read these flags. */
  get m_allows_polyline_routing(): boolean { return this._m_allows_polyline_routing; }
  get m_allows_orthogonal_routing(): boolean { return this._m_allows_orthogonal_routing; }
  ...
  // Late-bound external helpers (break circular deps)
  public _generateStaticOrthogonalVisGraph?: (router: Router) => void;
  public _improveOrthogonalRoutes?: (router: Router) => void;
  public _vertexVisibility?: (point: any, partner: any, knownNew: boolean, genContains?: boolean) => void;
  public _AStarPath?: new () => { search(lineRef: any, src: any, tar: any, start: any): void };
