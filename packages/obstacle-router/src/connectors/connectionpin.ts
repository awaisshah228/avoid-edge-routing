...
export class ShapeConnectionPin {
  ...
  private _initForShape(): void {
    ...
    this.m_vertex = new VertInf(this.m_router, id, this.position()) as any;
    ...
    if (this.m_router.m_allows_polyline_routing && (this.m_router as any)._vertexVisibility) {
      (this.m_router as any)._vertexVisibility(this.m_vertex, null, true, true);
    }
  }
  ...
  private _initForJunction(visDirs: number): void {
    ...
    const id = new VertID(this.m_junction!.id(), kShapeConnectionPin,
        PROP_ConnPoint | PROP_ConnectionPin);
    this.m_vertex = new VertInf(this.m_router, id, this.m_junction!.position()) as any;
  ...
  updateVisibility(): void {
    ...
    if (this.m_router && this.m_router.m_allows_polyline_routing && (this.m_router as any)._vertexVisibility) {
      (this.m_router as any)._vertexVisibility(this.m_vertex, null, true, true);
    }
  }
